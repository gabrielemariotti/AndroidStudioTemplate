 ...
 */ 
public class ${foregroundLinearLayoutClass} extends LinearLayout {
    ...
    public ${foregroundLinearLayoutClass}(Context context) {
        super(context);
    }
 
    public ${foregroundLinearLayoutClass}(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
 
    public ${foregroundLinearLayoutClass}(Context context, AttributeSet attrs, int defStyle) {
